      ...
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../Controller/index-admin.php">Liên Hệ</a>
              </li>
          </ul>
          <div class="user_option">
                <a href="../../Dự_án_1/Controller/index-home.php?request=user" class="user_link">
          ...
          <div class="user" style="margin-left:20px">
                <a href="../../Dự_án_1/Controller/index-admin.php?request=">
                  <?php 
                          if(isset($_SESSION['user'])){
                            extract($_SESSION['user']);
                  ?>
                  <span style="color: white">Hi, <?=$full_name?></span>
                  <?php } ?>
                </a>
          </div>
        </div>
