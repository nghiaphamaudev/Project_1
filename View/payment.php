...
<form action="../../Dự_án_1/Controller/index-home.php?request=confirm-payment" method="post">
            <div class="row">
                <div class="col-md-8 cart">
                    ...
                    <div class="row  border-bottom">
                        <div class="row main align-items-center">
                            ...
                            <div class="col"><h6><b>Vận Chuyển</b></h6></div>
                    ...
                    <div class="row border-top border-bottom">
                        ...
                        <div class="row main align-items-center">
                            ...
                            <div class="col">$<?=$price_delivery?></div>
                ...
                <div class="col-md-4 summary">
                    ...
                    <form>
                        <p>Tên người nhận</p>
                        <input type="text" name="name_receiver" placeholder="Nhập tên người nhận">
                        <p>Số điện thoại</p>
                        <input type="text" name="phone_receiver" placeholder=" Nhập số điện thoại người nhận">
                        <p>Địa chỉ</p>
                        <input type="text" name ="address_receiver"  placeholder="Nhập địa chỉ">
                    </form>
